// q3-- Write a program to insert a new node at the end to the linked list.
...
void display()                                                      //logic for printitng
{
	struct node *temp;
	if(head == NULL)
	{
...
void insert_end()                                                //logic for inserting node in the end in linked list
{
